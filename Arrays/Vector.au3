...
Func Test()
	Local $aVector = _Vector_Init(4)
	_Vector_Push($aVector, "Henlo1")
	_Vector_Push($aVector, "Henlo2")
	_Vector_Push($aVector, "Henlo3")
	_Vector_Push($aVector, "Henlo4")
	_Vector_Push($aVector, "Henlo5")
	_Vector_Push($aVector, "Henlo6")
	_Vector_Push($aVector, "Henlo7")
	_Vector_Push($aVector, "Henlo8")
	_Vector_Push($aVector, "Henlo9")
	_Vector_Set($aVector, 2, "Bye!")
	_Vector_Set($aVector, 50, "Not gonna happen")
	_Vector_Insert($aVector, 3, "Get outta here!")
	...
	For $v In _Vector_GetValues($aVector)
		...
		$i += 1
	Next
	ConsoleWrite("Size     = " & _Vector_GetSize($aVector) & @LF)
	ConsoleWrite("Capacity = " & _Vector_GetCapacity($aVector) & @LF & @LF)

	_Vector_EraseRange($aVector, 4, 4)
	...
	_Vector_EraseValue($aVector, "Henlo")
	_Vector_Erase($aVector, 1)
	_Vector_Erase($aVector, 50)
	...
	Local $vPopF = _Vector_PopFirst($aVector)
	Local $vPop = _Vector_Pop($aVector)
	ConsoleWrite("PopF = " & $vPopF & @LF)
	ConsoleWrite("Pop  = " & $vPop & @LF)

	$vPopF = _Vector_PopFirst($aVector)
	$vPop = _Vector_Pop($aVector)
	ConsoleWrite("PopF = " & $vPopF & @LF)
	ConsoleWrite("Pop  = " & $vPop & @LF )
