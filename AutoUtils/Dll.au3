...
;Address within the LoadBase to internally call LoadLibrary.
Global $__g_pDll_DllLoad      = 0

;Address within the LoadBase to internally call GetProcAddress.
Global $__g_pDll_DllGetAddr   = 0

;Address within the LoadBase to internally call FreeLibrary.
Global $__g_pDll_DllFree      = 0

;Address from the original LoadLibraryA function.
Global $__g_pDll_LoadLib      = 0

;Address from the original GetProcAddress function.
...
; Description ...: Checks if the Dll API is initialized.
...
; Syntax ........: _Dll_Open(Const $dDllBinary)
; Parameters ....: $dDllBinary          - [const]  Binary data of a Dll
; Return values .: DllModule Handle or 0 and sets errorcode to nonzero.
; Author ........: Zvend
; Remarks .......: If you have a string of opcodes. make sure that it starts with a '0x' and is converted with Binary().
; ...............: Errors: $DLLERR_INVALID_BINARY
; ...............:         $DLLERR_BINARY_NOT_MZ
; ...............:         $DLLERR_ALLOC_MEMORY
; ...............:         $DLLERR_FREE_MEMORY
; ...............:         $DLLERR_BINARY_NOT_32BIT
; ...............:         $DLLERR_BINARY_NOT_DLL
; ...............:         $DLLERR_LOAD_LIBRARY
...
Func _Dll_Open(Const $dDllBinary)
    ...
    Local $pDllBinaryAddr = VirtualAlloc(0, $nSize, 0x00001000, 0x00000004) ;MEM_COMMIT, PAGE_EXECUTE_READWRITE
    If @error Then
    ...
    Select
        ...
        Case Not BitAnd($nCharacteristics, $__IMAGE_FILE_EXECUTABLE_IMAGE)
            VirtualFree($pDllBinaryAddr, 0, 0x00008000) ;MEM_RELEASE
            Return SetError($DLLERR_BINARY_NOT_MZ, 0, 0)
...
; Return values .:  Address of the ProcName or 0 and sets errorcode to nonzero.
; Author ........: Zvend
; Remarks .......: Errors: $DLLERR_NOT_INITIALIZED
; ...............:         $DLLERR_INVALID_HANDLE
; ...............:         $DLLERR_DLLCALL_FAILED
; ===============================================================================================================================
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _Dll_Close
; Description ...: Closes a handle previously opened by _Dll_Call.
; Syntax ........: _Dll_Close($hDllHandle)
; Parameters ....: $hDllHandle          - [in/out and const]  DllModule Handle
; Return values .:  1 on success, 0 on failure and sets errorcode to nonzero.
; Author ........: Zvend
; Remarks .......: Errors: $DLLERR_NOT_INITIALIZED
; ...............:         $DLLERR_INVALID_HANDLE
; ...............:         $DLLERR_DLLCALL_FAILED
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _Dll_CloseAll
; Description ...: Frees every Dll previously loaded via _Dll_Open.
...
; Syntax ........: __Dll_IsDosMagic(Const $dDllBinary)
; Parameters ....: $dDllBinary          - [const]  Binary data of a Dll
...
; #FUNCTION# ====================================================================================================================
; Name ..........: __Dll_StartUp
; Description ...: Initializes the assembly and sets up internal variables. Gets called when using _Dll_Open and registers a shutdown callback when AutoIt exit.
; Syntax ........: __Dll_StartUp()
; Return values .: 1 on success, 0 on failure and sets errorcode to nonzero.
; Author ........: Zvend
; Remarks .......: Errors: $DLLERR_INVALID_BINARY
; ...............:         $DLLERR_ALLOC_MEMORY
; ...............:         $DLLERR_INVALID_HANDLE
; ...............:         $DLLERR_LOAD_LIBRARY
; ...............:         $DLLERR_GETPROCADDRESS
; ===============================================================================================================================
Func __Dll_StartUp()
    ...
    $__g_pDll_DllLoadBase = VirtualAlloc(0, $nSize, 0x00001000, 0x00000004) ;MEM_COMMIT, PAGE_EXECUTE_READWRITE
    ...
    If @error Then
        ...
        VirtualFree($__g_pDll_DllLoadBase, 0, 0x00008000) ;MEM_RELEASE
        Return SetError($DLLERR_INVALID_HANDLE, 0, 0)
    EndIf

    ;Getting Address of LoadLibraryA, which is needed for the setup
    $__g_pDll_LoadLib = GetProcAddress($hKernelModule, "LoadLibraryA")
    ...
    $__g_pDll_GetProcAddr = GetProcAddress($hKernelModule, "GetProcAddress")
...
; #FUNCTION# ====================================================================================================================
; Name ..........: __Dll_Shutdown
; Description ...: Frees the previous loaded dlls, deallocates assembly and internal variables. Gets auto called when AutoIt exits if initialized.
; Syntax ........: __Dll_Shutdown()
; Return values .: 1 on success, 0 on failure and sets errorcode to nonzero.
; Author ........: Zvend
; Remarks .......: Errors: $DLLERR_NOT_INITIALIZED
; ...............:         $DLLERR_FREE_MEMORY
...
; Parameters ....: $dDllBinary          - [const]  Binary data of a Dll
; Return values .: DllModule Handle, 0 if failed and sets errorcode to nonzero.
; Author ........: Zvend
; Remarks .......: Errors: $DLLERR_DLLCALL_FAILED
; ===============================================================================================================================
Func __Dll_LoadLibraryA(Const $dDllBinary)
...
; #FUNCTION# ====================================================================================================================
; Name ..........: __Dll_GetModuleExist
; Description ...: Checks if a module exist in the API vector.
; Syntax ........: __Dll_GetModuleExist($hDllHandle)
; Parameters ....: $hDllHandle          - [in/out and const]  DllModule Handle
; Return values .: 1 on success, 0 on failure.
; Author ........: Zvend
; ===============================================================================================================================
...
; Description ...: Returns the binary string of the custom assembly that makes it able to load dlls from memory, free dlls or get their exported functions.
; Syntax ........: __Dll_GetDllLoaderPayload()
; Return values .: 1 on success, 0 on failure.
; Author ........: Zvend
; Remarks .......: Errors: 1 - when Payload == ""
; ===============================================================================================================================
